...
Multi-agent design debate CLI. Powered by [OpenCode SDK](https://github.com/nicepkg/opencode).

Give it a prompt, and multiple AI agents will debate the architecture, then converge on a battle-tested spec.
...
Run twofer from inside your project directory. Agents will crawl through your codebase, reading files, checking dependencies, and understanding patterns, then produce a spec that builds on what you already have.
